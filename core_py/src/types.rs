...
#[pyclass]
#[pyo3(module = "boriy_core", name = "XLSXSheet", subclass)]
    ...
    pub fn write_cell(&mut self, row: u32, col: u32, value: String) -> PyResult<()> {
        Python::with_gil(|_py| {
            self.0
                ...
                .map_err(|e| PyRuntimeError::new_err(format!("Failed to wrile cell: {}", e)))
        })
    }
...
#[pyclass]
#[pyo3(module = "boriy_core", name = "XLSXSheetCell", subclass)]
#[derive(Debug, Clone, Serialize, Deserialize)]
